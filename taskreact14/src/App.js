...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
       ...
       {/* <!-- Masthead--> */}
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Portfolio Andri Ali Rahman</div>
                <h4>I'm exited to be here to meet you</h4>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <h4 class="my-3">Full Stuck Developer</h4>
                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/img/ginting.jpeg" alt="..." />
                            <h4>Sarman Ginting</h4>
                            <p class="text-muted">Mentor Full Stack Developer</p>
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/img/andri.jpeg" alt="..." />
                            <h4>Andri Ali Rahman</h4>
